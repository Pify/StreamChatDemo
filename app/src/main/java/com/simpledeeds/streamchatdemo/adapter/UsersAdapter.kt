package com.simpledeeds.streamchatdemo.adapter
...
import com.simpledeeds.streamchatdemo.databinding.UserRowLayoutBinding
import com.simpledeeds.streamchatdemo.ui.users.UsersFragmentDirections
...
class UsersAdapter : RecyclerView.Adapter<UsersAdapter.MyViewHolder>() {
    ...
    private fun createNewChannel(selectedUser : String, holder: UsersAdapter.MyViewHolder) {
